...
<footer class="footer">
    <div class="container-margin">
        ...
        <div class="row">
            ...
            <div class=" col-12  col-sm-12 col-md-4   col-xl-4">
                ...
                <p class="desc">أول مركز تسوق في قطاع غزة
                    فيه أجود المنتجات بأسعار منافسة</p>
                <form>
            ...
            <div class="col-6 col-sm-6 col-md-3 col-lg-3">
                ...
                <div class="info spe">
                    ...
                    <p>غزة_شارع الشهداء_غرب أصدقا المريض</p>
                    <p>هاتف:</p>
                    <p>28822888</p>
                    <p>البريد الالكتروني</p>
                    <p>metro@metro-market.ps</p>
                </div>
        ...
        <div class="polices">
            <div class="poli">
                <a href="#">سياسة البائع</a>
                <a href="#">سياسة العائدات</a>
                <a href="#"> سياسة الدعم</a>
                <a href="#"> سياسة التواصل</a>
            </div>
